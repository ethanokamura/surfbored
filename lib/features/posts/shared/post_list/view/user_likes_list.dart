...
// class UserLikesList extends StatelessWidget {
//   const UserLikesList({required this.userId, super.key});
//   final String userId;
//   @override
...
//               posts: posts,
//               onLoadMore: () async =>
//                   context.read<PostCubit>().fetchUserLikedPosts(userId),
//               onRefresh: () async => context
//                   .read<PostCubit>()
//                   .fetchUserLikedPosts(userId, refresh: true),
//             );
